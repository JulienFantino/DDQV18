...
";
        ...
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["questionnaire"]) || array_key_exists("questionnaire", $context) ? $context["questionnaire"] : (function () {
            ...
            // line 6
            echo "    <p>Votre demande concernant une demande d'attribution de place sur le parking Mourey a bien été transmise au service
        Ressources Humaines.</p>
    <p>Vous recevrez une notification par email lorsque votre demande aura été traitée.</p>
    <p>Tant que votre demande n'a pas été traitée, vous avez toujours la possibilité de la modifier via cette adresse
        :</p>
    <a href=\"";
            // line 11
...
";
                ...
                (isset($context["questionnaire"]) || array_key_exists("questionnaire", $context) ? $context["questionnaire"] : (function () {
                    throw new RuntimeError('Variable "questionnaire" does not exist.', 12, $this->source);
                })()), "idDdqCampagne", []), "idDdqCategorie", []), "libelle", []) == "RTT")) {
            // line 13
            echo "    <p>Votre choix de formule RTT a bien été transmise à votre responsable de service.</p>
    <p>Vous recevrez une notification par email lorsque votre demande aura été traitée.</p>
    <p>Tant que votre demande n'a pas été traitée, vous avez toujours la possibilité de la modifier via cette adresse
        :</p>
    <a href=\"";
...
";
                ...
                (isset($context["questionnaire"]) || array_key_exists("questionnaire", $context) ? $context["questionnaire"] : (function () {
                    throw new RuntimeError('Variable "questionnaire" does not exist.', 18, $this->source);
                })()), "idDdqCampagne", []), "idDdqCategorie", []), "libelle", []) == "Temps_partiel")) {
            // line 19
            echo "    <p>Votre demande Temps partiel a bien été transmise à votre responsable de service.</p>
    <p>Vous recevrez une notification par email lorsque votre demande aura été traitée.</p>
    <p>Tant que votre demande n'a pas été traitée, vous avez toujours la possibilité de la modifier via cette adresse
        :</p>
    <a href=\"";
...
";
    ...
    {
        return array(94 => 27, 90 => 25, 85 => 23, 79 => 19, 77 => 18, 73 => 17, 67 => 13, 65 => 12, 61 => 11, 54 => 6, 52 => 5, 45 => 3, 41 => 1,);
    }
...
{% if questionnaire.idDdqCampagne.idDdqCategorie.libelle == 'Parking' %}
    <p>Votre demande concernant une demande d'attribution de place sur le parking Mourey a bien été transmise au service
        Ressources Humaines.</p>
    <p>Vous recevrez une notification par email lorsque votre demande aura été traitée.</p>
    <p>Tant que votre demande n'a pas été traitée, vous avez toujours la possibilité de la modifier via cette adresse
        :</p>
...
{% elseif questionnaire.idDdqCampagne.idDdqCategorie.libelle == 'RTT' %}
    <p>Votre choix de formule RTT a bien été transmise à votre responsable de service.</p>
    <p>Vous recevrez une notification par email lorsque votre demande aura été traitée.</p>
    <p>Tant que votre demande n'a pas été traitée, vous avez toujours la possibilité de la modifier via cette adresse
        :</p>
    <a href=\"{{ url('campagnes_rtt') }}\">Votre campagne RTT</a>
{% elseif questionnaire.idDdqCampagne.idDdqCategorie.libelle == 'Temps_partiel' %}
    <p>Votre demande Temps partiel a bien été transmise à votre responsable de service.</p>
    <p>Vous recevrez une notification par email lorsque votre demande aura été traitée.</p>
    <p>Tant que votre demande n'a pas été traitée, vous avez toujours la possibilité de la modifier via cette adresse
        :</p>
