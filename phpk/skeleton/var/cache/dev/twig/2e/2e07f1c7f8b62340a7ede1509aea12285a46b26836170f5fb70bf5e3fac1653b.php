...
class __TwigTemplate_5171a80519780f02ae49afe9d595328e85a4ab95608ae4edd2f8dc45a4ea07fe extends \Twig\Template
{
    private $source;
...
<table class=\"logs\">
    <thead>
        ...
        if ((isset($context["channel_is_defined"]) || array_key_exists("channel_is_defined", $context) ? $context["channel_is_defined"] : (function () {
            throw new RuntimeError('Variable "channel_is_defined" does not exist.', 7, $this->source);
        })())) {
            echo "<th>Channel</th>";
        }
        // line 8
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["log"]) {
            ...
            if ((twig_get_attribute($this->env, $this->source, $context["log"], "priority", []) >= 400)) {
                ...
                // line 20
                echo "            ";
                $context["status"] = (((((isset($context["severity"]) || array_key_exists("severity", $context) ? $context["severity"] : (function () {
                            throw new RuntimeError('Variable "severity" does not exist.', 20, $this->source);
                        })()) === constant("E_DEPRECATED")) || ((isset($context["severity"]) || array_key_exists("severity", $context) ? $context["severity"] : (function () {
                            throw new RuntimeError('Variable "severity" does not exist.', 20, $this->source);
                        })()) === constant("E_USER_DEPRECATED")))) ? ("warning") : ("normal"));
                // line 21
                echo "        ";
            }
            // line 22
            echo "        <tr class=\"status-";
            echo twig_escape_filter($this->env, (isset($context["status"]) || array_key_exists("status", $context) ? $context["status"] : (function () {
                throw new RuntimeError('Variable "status" does not exist.', 22, $this->source);
            })()), "html", null, true);
            echo "\">
            ...
            // line 27
            if ((isset($context["channel_is_defined"]) || array_key_exists("channel_is_defined", $context) ? $context["channel_is_defined"] : (function () {
                throw new RuntimeError('Variable "channel_is_defined" does not exist.', 27, $this->source);
            })())) {
                // line 28
...
", "@Twig/Exception/logs.html.twig", "/var/www/html/app/DDQV8/phpk/skeleton/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/logs.html.twig");
    }
}
