...
// Returns the private 'monolog.logger.phpk_security.bntsa' shared service.

$this->services['monolog.logger.phpk_security.bntsa'] = $instance = new \Symfony\Bridge\Monolog\Logger('phpk_security.bntsa');
