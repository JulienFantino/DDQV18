...
// Returns the private 'monolog.logger.phpk_wsclient' shared service.

$this->services['monolog.logger.phpk_wsclient'] = $instance = new \Symfony\Bridge\Monolog\Logger('phpk_wsclient');
