...
// Returns the private 'monolog.logger.phpk_security.authapp' shared service.

$this->services['monolog.logger.phpk_security.authapp'] = $instance = new \Symfony\Bridge\Monolog\Logger('phpk_security.authapp');
