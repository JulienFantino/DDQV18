...
include_once $this->targetDirs[3] . '/vendor/cnamts/phpk/bundles/phpk-security-bundle/Authenticator/AccessMasterAuthenticator.php';
...
$d = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $c, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($c, 'app_index'), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'phpk_logout']);
...
return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 2 => ${($_ = isset($this->services['security.authentication.listener.guard.secured_area']) ? $this->services['security.authentication.listener.guard.secured_area'] : $this->load('getSecurity_Authentication_Listener_Guard_SecuredAreaService.php')) && false ?: '_'};
...
}, 4), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ${($_ = isset($this->services['security.authentication.trust_resolver']) ? $this->services['security.authentication.trust_resolver'] : ($this->services['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver('Symfony\\Component\\Security\\Core\\Authentication\\Token\\AnonymousToken', 'Symfony\\Component\\Security\\Core\\Authentication\\Token\\RememberMeToken'))) && false ?: '_'}, $c, 'secured_area', ${($_ = isset($this->services['phpk.accessmaster_authenticator']) ? $this->services['phpk.accessmaster_authenticator'] : ($this->services['phpk.accessmaster_authenticator'] = new \CNAMTS\PHPK\SecurityBundle\Authenticator\AccessMasterAuthenticator($this))) && false ?: '_'}, NULL, NULL, ${($_ = isset($this->services['monolog.logger.security']) ? $this->services['monolog.logger.security'] : $this->load('getMonolog_Logger_SecurityService.php')) && false ?: '_'}, false), $d, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('secured_area', 'security.user_checker', 'security.request_matcher.00qf1z7', true, false, NULL, 'secured_area', 'phpk.accessmaster_authenticator', NULL, NULL, [0 => 'guard'], NULL));
