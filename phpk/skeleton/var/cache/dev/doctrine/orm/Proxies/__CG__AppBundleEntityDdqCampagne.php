 ...
 */
class DdqCampagne extends \AppBundle\Entity\DdqCampagne implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\DdqCampagne' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\DdqCampagne' . "\0" . 'libelle', '' . "\0" . 'AppBundle\\Entity\\DdqCampagne' . "\0" . 'datedebut', '' . "\0" . 'AppBundle\\Entity\\DdqCampagne' . "\0" . 'datefin', '' . "\0" . 'AppBundle\\Entity\\DdqCampagne' . "\0" . 'statut', '' . "\0" . 'AppBundle\\Entity\\DdqCampagne' . "\0" . 'idDdqCategorie'];
        }
    ...
    {
        if (!$this->__isInitialized__) {
            $this->__initializer__ = function (DdqCampagne $proxy) {
    ...
    public function setIdDdqCategorie(\AppBundle\Entity\DdqCategorie $idDdqCategorie = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdDdqCategorie', [$idDdqCategorie]);

        return parent::setIdDdqCategorie($idDdqCategorie);
    }
    ...
    public function getIdDdqCategorie()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdDdqCategorie', []);

        return parent::getIdDdqCategorie();
    }
