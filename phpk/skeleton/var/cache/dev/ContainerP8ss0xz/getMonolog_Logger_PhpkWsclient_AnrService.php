...
// Returns the private 'monolog.logger.phpk_wsclient.anr' shared service.

$this->services['monolog.logger.phpk_wsclient.anr'] = $instance = new \Symfony\Bridge\Monolog\Logger('phpk_wsclient.anr');
