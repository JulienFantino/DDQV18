...
// Returns the private 'monolog.logger.phpk_security.crypto' shared service.

$this->services['monolog.logger.phpk_security.crypto'] = $instance = new \Symfony\Bridge\Monolog\Logger('phpk_security.crypto');
