...
// Returns the private 'monolog.logger.phpk_wsclient.espoir' shared service.

$this->services['monolog.logger.phpk_wsclient.espoir'] = $instance = new \Symfony\Bridge\Monolog\Logger('phpk_wsclient.espoir');
