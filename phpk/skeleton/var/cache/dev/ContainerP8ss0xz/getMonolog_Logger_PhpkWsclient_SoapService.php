...
// Returns the private 'monolog.logger.phpk_wsclient.soap' shared service.

$this->services['monolog.logger.phpk_wsclient.soap'] = $instance = new \Symfony\Bridge\Monolog\Logger('phpk_wsclient.soap');
