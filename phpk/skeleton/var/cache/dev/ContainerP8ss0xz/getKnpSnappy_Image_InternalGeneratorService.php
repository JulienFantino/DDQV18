...
// Returns the private 'knp_snappy.image.internal_generator' shared service.
...
return $this->services['knp_snappy.image.internal_generator'] = new \Knp\Snappy\Image('../bin/wkhtmltoimage-amd64', [], NULL);
